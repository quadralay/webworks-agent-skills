...
- `plugins/webworks-claude-skills/skills/reverb2/scripts/resolve-landmarks.py` — the resolver
- `plugins/webworks-claude-skills/skills/reverb2/workflows/landmark-resolution.md` — workflow doc
- `plugins/webworks-claude-skills/skills/reverb2/tests/verify-landmark-resolver.py` — 28 verification scenarios covering opaque IDs, multi-chunk merge, last-write-wins, and the full CLI contract
...
- GitHub issue #54 — feature request and design discussion
